...
/* pages.html.twig */
class __TwigTemplate_3da66251dc25157c7cde1577d73dfecad8156bc748e3f0f3576e50f29bcb53d4 extends Twig_Template
{
...
($context["mode"] ?? null) == "edit")) {
    ...
    ";
        ...
        if ((($context["mode"] ?? null) == "new")) {
            // line 259
            echo "        ";
            $this->loadTemplate("partials/blueprints-new.html.twig", "pages.html.twig", 259)->display(array_merge($context, array("blueprints" => $this->getAttribute(($context["admin"] ?? null), "blueprints", array(0 => "pages/page"), "method"), "data" => ($context["context"] ?? null))));
            // line 260
            echo "    ";
            ...
            if (($this->getAttribute($this->getAttribute(($context["context"] ?? null), "blueprints", array()), "fields", array()) && ($this->getAttribute($this->getAttribute(($context["admin"] ?? null), "session", array()), "expert", array()) == "0"))) {
                // line 308
                echo "                ";
                $this->loadTemplate("partials/blueprints.html.twig", "pages.html.twig", 308)->display(array_merge($context, array("blueprints" => $this->getAttribute(($context["context"] ?? null), "blueprints", array()), "data" => ($context["context"] ?? null))));
                // line 309
                echo "            ";
            } else {
                // line 310
                echo "                ";
                $this->loadTemplate("partials/blueprints-raw.html.twig", "pages.html.twig", 310)->display(array_merge($context, array("blueprints" => $this->getAttribute(($context["admin"] ?? null), "blueprints", array(0 => (("admin/pages/" . ($context["modular"] ?? null)) . "raw")), "method"), "data" => ($context["context"] ?? null))));
                // line 311
                echo "            ";
            }
            // line 312
    ...
    ";
        ...
        <div class=\"pages-list\">
            ...
            ";
            // line 330
            $this->loadTemplate("partials/page-legend.html.twig", "pages.html.twig", 330)->display($context);
            // line 331
            echo "        </div>
    ";
        }
    ...
    ";
        ...
        ";
            // line 345
            $this->loadTemplate("partials/blueprints-new.html.twig", "pages.html.twig", 345)->display(array_merge($context, array("blueprints" => $this->getAttribute(($context["admin"] ?? null), "blueprints", array(0 => "admin/pages/new"), "method"), "data" => ($context["obj_data"] ?? null), "form_id" => "new-page")));
            // line 346
            echo "    </div>
    ...
    <div class=\"remodal\" data-remodal-id=\"modal-folder\" data-remodal-options=\"hashTracking: false\">
        ";
            // line 349
            $this->loadTemplate("partials/blueprints-new-folder.html.twig", "pages.html.twig", 349)->display(array_merge($context, array("blueprints" => $this->getAttribute(($context["admin"] ?? null), "blueprints", array(0 => "admin/pages/new_folder"), "method"), "data" => ($context["obj_data"] ?? null), "form_id" => "new-folder")));
            // line 350
            echo "    </div>
    ...
    <div class=\"remodal\" data-remodal-id=\"modular\" data-remodal-options=\"hashTracking: false\">
        ";
            // line 353
            $this->loadTemplate("partials/blueprints-new.html.twig", "pages.html.twig", 353)->display(array_merge($context, array("blueprints" => $this->getAttribute(($context["admin"] ?? null), "blueprints", array(0 => "admin/pages/modular_new"), "method"), "data" => ($context["obj_data"] ?? null), "form_id" => "new-modular")));
            // line 354
            echo "    </div>
    ...
    ";
        ...
        ";
            // line 367
            $this->loadTemplate("partials/page-move.html.twig", "pages.html.twig", 367)->display(array_merge($context, array("blueprints" => $this->getAttribute(($context["admin"] ?? null), "blueprints", array(0 => "admin/pages/move"), "method"), "data" => ($context["context"] ?? null))));
            // line 368
            echo "    </div>
    <div class=\"remodal\" data-remodal-id=\"revisions\" data-remodal-options=\"hashTracking: false\">
        ";
            // line 370
            try {
                $this->loadTemplate(array(0 => "partials/page-revisions.html.twig", 1 => "empty.html.twig"), "pages.html.twig", 370)->display(array_merge($context, array("data" => ($context["context"] ?? null))));
    ...
    ";
        // line 374
        $this->loadTemplate("partials/modal-changes-detected.html.twig", "pages.html.twig", 374)->display($context);
        // line 375
        echo "
    ...
    ";
        // line 395
        try {
            $this->loadTemplate("partials/admin-pro-pages-addons.html.twig", "pages.html.twig", 395)->display($context);
        } catch (Twig_Error_Loader $e) {
            // ignore missing template
        }
...
";
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["p"]) {
                // line 70
                echo "        ";
                $context["description"] = (((((( !$this->getAttribute($context["p"], "page", array())) ? (($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.FOLDER") . " &bull; ")) : (($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.PAGE") . " &bull; "))) . (($this->getAttribute(                // line 71
$context["p"], "modular", array())) ? (($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.MODULAR") . " &bull; ")) : (""))) . (($this->getAttribute(                // line 72
$context["p"], "routable", array())) ? (($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.ROUTABLE") . " &bull; ")) : (($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.NON_ROUTABLE") . " &bull; ")))) . (($this->getAttribute(                // line 73
$context["p"], "visible", array())) ? (($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.VISIBLE") . " &bull; ")) : (($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.NON_VISIBLE") . " &bull; ")))) . (($this->getAttribute(                // line 74
$context["p"], "published", array())) ? (($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.PUBLISHED") . " &bull; ")) : (($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.NON_PUBLISHED") . " &bull; "))));
    ...
    {
        return array (  1117 => 114,  1111 => 111,  1106 => 110,  1104 => 109,  1100 => 107,  1094 => 105,  1088 => 103,  1086 => 102,  1081 => 101,  1078 => 100,  1076 => 99,  1068 => 96,  1065 => 95,  1061 => 93,  1058 => 92,  1048 => 90,  1046 => 89,  1038 => 87,  1036 => 86,  1032 => 85,  1023 => 81,  1019 => 80,  1014 => 78,  1011 => 77,  1009 => 76,  1006 => 75,  1004 => 74,  1003 => 73,  1002 => 72,  1001 => 71,  999 => 70,  995 => 69,  992 => 68,  989 => 67,  986 => 66,  983 => 65,  980 => 64,  977 => 63,  974 => 62,  971 => 61,  968 => 60,  966 => 59,  963 => 58,  960 => 57,  957 => 56,  954 => 55,  951 => 54,  948 => 53,  945 => 52,  942 => 51,  939 => 50,  936 => 49,  922 => 48,  904 => 4,  891 => 3,  884 => 400,  881 => 399,  876 => 396,  869 => 395,  861 => 390,  857 => 389,  850 