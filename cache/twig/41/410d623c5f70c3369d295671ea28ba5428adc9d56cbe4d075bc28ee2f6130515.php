...
class __TwigTemplate_6a8a1ad747befd40969581579874750b82aaa486aeb5ea88400e2406e58bb3c3 extends Twig_Template
{
...
\t<script>(function(){function run(){tinymce.init({selector:\"textarea.tinymce\",document_base_url:\$(\"[id=grav-dropzone]\").attr(\"data-media-local\")+\"/../\"+(0";
        // line 22
        if ($this->getAttribute(($context["context"] ?? null), "modular", array())) {
            echo "1";
        }
        echo "?\"../\":\"\"),language_url:langs+lang+js,plugins:\"";
        echo twig_escape_filter($this->env, twig_escape_filter($this->env, twig_join_filter($this->getAttribute($this->getAttribute($this->getAttribute(($context["config"] ?? null), "plugins", array()), "tinymce-editor", array(), "array"), "plugins", array()), " "), "js"), "html", null, true);
        echo "\",";
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_array_keys_filter($this->getAttribute($this->getAttribute($this->getAttribute(($context["config"] ?? null), "plugins", array()), "tinymce-editor", array(), "array"), "parameters", array())));
        foreach ($context['_seq'] as $context["_key"] => $context["key"]) {
            echo "\"";
            echo twig_escape_filter($this->env, twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["config"] ?? null), "plugins", array()), "tinymce-editor", array(), "array"), "parameters", array()), $context["key"], array(), "array"), "name", array()), "js"), "html", null, true);
            echo "\":";
            if (($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["config"] ?? null), "plugins", array()), "tinymce-editor", array(), "array"), "parameters", array()), $context["key"], array(), "array"), "value", array()) == "0")) {
                echo "0";
            } elseif (($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["config"] ?? null), "plugins", array()), "tinymce-editor", array(), "array"), "parameters", array()), $context["key"], array(), "array"), "value", array()) == "false")) {
                echo "false";
            } else {
                echo "\"";
                echo twig_escape_filter($this->env, twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["config"] ?? null), "plugins", array()), "tinymce-editor", array(), "array"), "parameters", array()), $context["key"], array(), "array"), "value", array()), "js"), "html", null, true);
                echo "\"";
            }
            echo ",";
        }
        ...
        echo "menubar:";
        if ($this->getAttribute($this->getAttribute($this->getAttribute(($context["config"] ?? null), "plugins", array()), "tinymce-editor", array(), "array"), "menubar", array())) {
            echo "true";
        } else {
            echo "false";
        }
        echo ",menu:{ ";
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_array_keys_filter($this->getAttribute($this->getAttribute($this->getAttribute(($context["config"] ?? null), "plugins", array()), "tinymce-editor", array(), "array"), "menu", array())));
        foreach ($context['_seq'] as $context["_key"] => $context["key"]) {
            echo twig_escape_filter($this->env, $context["key"], "html", null, true);
            echo ":{title:\"";
            echo twig_escape_filter($this->env, twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["config"] ?? null), "plugins", array()), "tinymce-editor", array(), "array"), "menu", array()), $context["key"], array(), "array"), "title", array()), "js"), "html", null, true);
            echo "\",items:\"";
            echo twig_escape_filter($this->env, twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["config"] ?? null), "plugins", array()), "tinymce-editor", array(), "array"), "menu", array()), $context["key"], array(), "array"), "items", array()), "js"), "html", null, true);
            echo "\"},";
        }
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['key'], $context['_parent'], $context['loop']);
        ...
        echo "},toolbar:[";
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getAttribute($this->getAttribute(($context["config"] ?? null), "plugins", array()), "tinymce-editor", array(), "array"), "toolbar", array()));
        ...
        $context = array_intersect_key($context, $_parent) + $_parent;
        echo "],branding:";
        if ($this->getAttribute($this->getAttribute($this->getAttribute(($context["config"] ?? null), "plugins", array()), "tinymce-editor", array(), "array"), "branding", array())) {
            echo "true";
        } else {
            echo "false";
        }
        echo ",statusbar:";
        if ($this->getAttribute($this->getAttribute($this->getAttribute(($context["config"] ?? null), "plugins", array()), "tinymce-editor", array(), "array"), "statusbar", array())) {
            echo "true";
        } else {
            echo "false";
        }
...
{% endblock %}
", "forms/fields/tinymce/tinymce.html.twig", "/Applications/MAMP/htdocs/grav-demo/user/plugins/tinymce-editor/templates/forms/fields/tinymce/tinymce.html.twig");
    }
}
